        ...
        {!loading && data.length > 0 && (
          <div className="flex items-center gap-4">
            ...
            <div className="rounded-xl bg-brand-bg px-3 py-1.5 text-center">
              ...
              <p className="text-sm font-bold text-brand-slate">{currentWeight} kg</p>
            </div>
      ...
      {loading ? (
        ...
        <ResponsiveContainer width="100%" height={220}>
          ...
          >
            ...
            <Tooltip content={<CustomTooltip />} cursor={{ stroke: '#D9AAE3', strokeWidth: 1.5 }} />
            ...
            <Area
              ...
              activeDot={{ r: 5, fill: '#9567B9', stroke: '#fff', strokeWidth: 2 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      )}
