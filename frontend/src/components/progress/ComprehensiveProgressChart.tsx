...
> = {
  ...
  workoutSessions: {
    ...
    shortLabel: "Sessions",
    color: "#9567B9",
    twColor: "bg-brand-deep",
    icon: <Activity size={13} />,
    dataKey: "workout_sessions",
    type: "bar",
    category: "Fitness",
    unit: "",
  },
  workoutCalories: {
    ...
    shortLabel: "W.Calories",
    color: "#FCB60F",
    twColor: "bg-brand-gold",
    icon: <Activity size={13} />,
    dataKey: "workout_calories",
    type: "line",
    category: "Fitness",
    unit: "kcal",
  },
  workoutDuration: {
    ...
    shortLabel: "Duration",
    color: "#C98CE8",
    twColor: "bg-brand-soft",
    icon: <Activity size={13} />,
    dataKey: "workout_duration_minutes",
    type: "line",
    category: "Fitness",
    unit: "min",
  },
  dietCalories: {
    label: "Diet Calories",
    shortLabel: "D.Calories",
    color: "#D9AAE3",
    twColor: "bg-brand-mauve",
    icon: <Utensils size={13} />,
    dataKey: "diet_calories_consumed",
    type: "line",
    category: "Diet",
    unit: "kcal",
  },
  hydration: {
    ...
    color: "#515A6A",
    twColor: "bg-brand-slate",
    icon: <Droplets size={13} />,
    dataKey: "hydration_ml",
    type: "line",
    category: "Hydration",
    unit: "ml",
  },
...
function SummaryStrip({
  ...
  const stats = [
    ...
    {
      label: "W. Calories",
      value: Math.round(data.total_workout_calories),
      unit: "kcal",
      color: "#FCB60F",
      icon: <Activity size={14} />,
    },
    {
      label: "Diet Cal",
      value: Math.round(data.total_calories_consumed),
      unit: "kcal",
      color: "#D9AAE3",
    ...
    {
      label: "Hydration",
      value: (data.total_hydration_ml / 1000).toFixed(1),
      unit: "L",
      color: "#515A6A",
    ...
    {
      label: "Goals Done",
      value: data.goals_completed_in_period,
      unit: "",
      color: "#9567B9",
      icon: <Trophy size={14} />,
    },
...
export default function ComprehensiveProgressChart() {
  ...
  */
  ...
  const hasSmallScale = activeMetrics.some((m) =>
    ["weight", "workoutSessions", "workoutDuration", "goalsCompleted"].includes(
      m,
    ),
  );
          ...
          <div className="rounded-2xl border border-brand-pale bg-brand-bg/40 p-4">
            <ResponsiveContainer width="100%" height={360}>
              ...
              >
                <defs>
                  {activeMetrics
                    .filter((m) => METRIC_CONFIG[m].type === "line")
                    .map((m) => (
                      <linearGradient
                        key={m}
                        id={`grad-${m}`}
                      ...
                      >
                        <stop
                          offset="5%"
                          stopColor={METRIC_CONFIG[m].color}
                          stopOpacity={0.12}
                        />
                        <stop
                          offset="95%"
                ...
                <Tooltip
                  ...
                  cursor={{ stroke: "#D9AAE3", strokeWidth: 1 }}
                />
      ...
      {!loading && !error && chartData.length === 0 && (
        <div className="flex flex-col items-center gap-2 rounded-2xl border border-brand-pale bg-brand-bg py-14 text-center">
          ...
          <p className="max-w-xs text-xs text-brand-slate/45">
            Start logging workouts, meals, and measurements to see your progress
            here.
          </p>
        </div>
      )}
