...
export default function GoalsDashboard() {
  ...
  const [completedGoals, setCompletedGoals] = useState<CompletedGoal[]>(COMPLETED_GOALS)
    ...
    setCompletedGoals((prev) => [
      {
        ...
        achievedLabel: `${goal.currentValue} / ${goal.targetValue} ${goal.unit} - Completed ${new Date().toLocaleDateString('en-US', {
          month: 'short',
          day: 'numeric',
          year: 'numeric'
        })}`
