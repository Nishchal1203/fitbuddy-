...
export default function ChatSidebar({
  ...
  return (
    ...
    >
      ...
      <div className={`flex h-14 flex-shrink-0 items-center border-b border-brand-pale ${
        ...
        {isOpen && (
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-semibold text-brand-slate">Back to Dashboard</p>
          </div>
        )}
      ...
      {/* ── New Chat ── */}
      <div className={`flex-shrink-0 pt-3 ${isOpen ? "px-3" : "flex justify-center px-0"}`}>
        {isOpen ? (
          <button
            onClick={onNewChat}
      ...
      {/* ── Search ── */}
      <div className={`flex-shrink-0 pt-2 ${isOpen ? "px-3" : "flex justify-center px-0"}`}>
        {isOpen ? (
      ...
      <div className="min-h-0 flex-1 overflow-y-auto py-2">
        ...
        {conversations.length === 0 && (
          <div className="flex flex-col items-center gap-1.5 py-10 text-center">
            {isOpen ? (
              <>
                <p className="text-xs font-semibold text-brand-slate/50">No chats yet</p>
                <p className="text-[10px] text-brand-slate/35">Start a new chat to begin</p>
              </>
            ) : (
