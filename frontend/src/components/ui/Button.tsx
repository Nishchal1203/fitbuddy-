...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-brand-pale text-brand-deep hover:bg-brand-mauve focus-visible:ring-primary-400",
  outline:
    "border border-brand-pale bg-white text-brand-slate hover:bg-brand-bg focus-visible:ring-primary-400",
